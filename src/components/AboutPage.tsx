...
export default function AboutPage() {
  return (
    <div className="space-y-8">
      ...
      <div className="mt-12 flex justify-center items-center py-8 opacity-80 hover:opacity-100 transition-opacity duration-700">
        <img src="/handwriting.png" alt="Sanmao's Handwriting" className="max-w-xl w-full object-contain filter drop-shadow-md" />
      </div>
    </div>
  );
}
